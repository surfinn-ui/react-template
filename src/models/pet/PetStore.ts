  ...
  .actions((self) => {
    ...
    const uploadFile = flow(function* (
      ...
      if (response.kind === 'ok') {
        ...
        const data = response.data.data as IApiResponseModel;

        // --------------------------------------------------------------------
        console.log('uploadFile()', JSON.stringify(data, null, 2));
        throw new Error('TODO - TRANSLATE RESPONSE TO STORE uploadFile()');
        // --------------------------------------------------------------------
    ...
    const getPetById = flow(function* (petId: number) {
      ...
      if (response.kind === 'ok') {
        // TODO - TRANSLATE RESPONSE TO STORE
        const data = response.data.data as IPetModel;

        // --------------------------------------------------------------------
        console.log('getPetById()', JSON.stringify(data, null, 2));
        throw new Error('TODO - TRANSLATE RESPONSE TO STORE getPetById()');
        // --------------------------------------------------------------------
    ...
    const updatePetWithForm = flow(function* (
      ...
      if (response.kind === 'ok') {
        ...
        throw new Error(
          'TODO - TRANSLATE RESPONSE TO STORE updatePetWithForm()',
        );
        // --------------------------------------------------------------------
    ...
    const deletePet = flow(function* (petId: number) {
      ...
      if (response.kind === 'ok') {
        ...
        throw new Error('TODO - TRANSLATE RESPONSE TO STORE deletePet()');
        // --------------------------------------------------------------------
    ...
    const findPetsByTags = flow(function* (tags: string[]) {
      ...
      if (response.kind === 'ok') {
        ...
        throw new Error('TODO - TRANSLATE RESPONSE TO STORE findPetsByTags()');
        // --------------------------------------------------------------------
    ...
    const findPetsByStatus = flow(function* (status: string) {
      ...
      if (response.kind === 'ok') {
        ...
        throw new Error(
          'TODO - TRANSLATE RESPONSE TO STORE findPetsByStatus()',
        );
        // --------------------------------------------------------------------
    ...
    const updatePet = flow(function* (payload: any) {
      ...
      if (response.kind === 'ok') {
        ...
        throw new Error('TODO - TRANSLATE RESPONSE TO STORE updatePet()');
        // --------------------------------------------------------------------
    ...
    const addPet = flow(function* (payload: any) {
      ...
      if (response.kind === 'ok') {
        ...
        throw new Error('TODO - TRANSLATE RESPONSE TO STORE addPet()');
        // --------------------------------------------------------------------
